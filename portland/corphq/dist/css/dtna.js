...
$(document).ready(function () {
	...
	// for debugging when the carousel is running.
	...
	// link code for carousel images
	$('#about_carousel').click(function(){
		window.location.href=('about.html');
	});

	$('#people_carousel').click(function(){
		window.location.href=('people.html');
	});

	$('#media_carousel').click(function(){
		window.location.href=('media.html');
	});

	$('#buzz_carousel').click(function(){
	...
	// set the mailto button for the footer. 11-24-15
	$("#mailtor2l").on('click',function(){
		window.location.href = "mailto:info-R2L@Daimler.com";
	});
...
// table code removed as it is in process at this time in the framework and not used on this site. Get the latest from 
// the framework and insert it here if needed. 
...
function startVideo(){
	$('.mediaButton').click(function(e){
		$('.mediaButton').removeClass('activeMedia');
		$('.media_featured_intro_image').show();
		var videoSource = "media/" + $(this).data("mediafile");
		$(".media_featured").attr('src',videoSource);
	...
	$('.media_featured_intro_image').click(function(e){
		$('.media_featured_intro_image').show();
		$(".media_featured")[0].play();
		$('.media_featured ').show();
		$('.media_featured_intro_image').hide();
...
function getQueryString(){
	...
	var videoSource = $("." + queries.video).data("mediafile");
